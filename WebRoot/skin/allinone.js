...
/* modaldialog.js */
var HEADER="Reminder";var TEXT_1="Community projects represent the latest development releases and are ";var UNDERLINED_1="not";var TEXT_1a=" supported.";var TEXT_2="If you're looking for fully supported, certified, enterprise middleware try ";var LINKTEXT_1="JBoss Enterprise Middleware";var TEXT_2a=" products. \u00a0\u00a0\u00a0\u00a0\u00a0\u00a0\u00a0\u00a0";var DETAILS="Show Details";var ENTERPRISE_LINK="http://www.jboss.com/products";var DETAILS_LINK="http://www.jboss.com/products/community-enterprise/";var JBOSSCOM="Show Details";var CONTINUE="Continue Download";var CANCEL="Cancel Download";function turnOnModal(downloadAnhor){turnOnModal(downloadAnhor,null);}
function turnOnModal(downloadAnhor,gaFileID){tkOnModal();createDownloadsBox(downloadAnhor.href,gaFileID);}
function createDownloadsBox(url){createDownloadsBox(url,null);}
function createDownloadsBox(url,gaFileID){if(document.getElementById("modallayer"))return;var mObj=document.getElementsByTagName("body")[0].appendChild(document.createElement("div"));mObj.id="modallayer";mObj.style.height=document.documentElement.scrollHeight+"px";var alertObj=mObj.appendChild(document.createElement("div"));alertObj.id="dialog";var div=alertObj.appendChild(document.createElement("div"));var h=div.appendChild(document.createElement("h4"));h.appendChild(document.createTextNode(HEADER));var p1=div.appendChild(document.createElement("p"));p1.style.fontWeight="bold";p1.appendChild(document.createTextNode(TEXT_1));var u1=document.createElement("u");u1.appendChild(document.createTextNode(UNDERLINED_1));p1.appendChild(u1);p1.appendChild(document.createTextNode(TEXT_1a));var p2=div.appendChild(document.createElement("p"));p2.appendChild(document.createTextNode(TEXT_2));var a=p2.appendChild(document.createElement("a"));a.appendChild(document.createTextNode(LINKTEXT_1));a.href=ENTERPRISE_LINK;a.onclick=function(){turnOffModal();tkForums();return true;};p2.appendChild(document.createTextNode(TEXT_2a));var a2=p2.appendChild(document.createElement("a"));a2.appendChild(document.createTextNode(DETAILS));a2.href=DETAILS_LINK;a2.onclick=function(){turnOffModal();tkJBossCom();return true;};var btnrow=alertObj.appendChild(document.createElement("div"));btnrow.id="buttonrow";var ul=btnrow.appendChild(document.createElement("ul"));if(gaFileID==null){ul.appendChild(createLi(CONTINUE,"continue",url,function(){turnOffModal();tkContinue();return true;}));}
else{ul.appendChild(createLi(CONTINUE,"continue",url,function(){pageTracker._trackPageview(gaFileID);turnOffModal();tkContinue();return true;}));}
ul.appendChild(createLi(CANCEL,"cancel","#",function(){turnOffModal();tkCancel();return false;}));var dialogWindow=$("#dialog");dialogWindow.css("position","absolute");dialogWindow.css("top",($(window).height()-dialogWindow.height())/2+$(window).scrollTop()+"px");dialogWindow.css("left",($(window).width()-dialogWindow.width())/2+$(window).scrollLeft()+"px");dialogWindow.fadeIn(300);}
function createLi(text,id,url,onclick){var li=document.createElement("li");var a=li.appendChild(document.createElement("a"));a.appendChild(document.createTextNode(text));a.className="hrefbuttons";a.onclick=onclick;a.href=url;a.id=id;return li;}
function turnOffModal(){$("#modallayer").css("display","none");document.getElementsByTagName("body")[0].removeChild(document.getElementById("modallayer"));}
function tk(suffix){s.pageName=location.pathname+"/"+suffix;void(s.t());}
...
function init(){var elements=getElementsByStyleClass("rowline");for(var e=0;e<elements.length;e++){var children=elements[e].childNodes;for(var c=0;c<children.length;c++){var child=children[c];if((child!=null)&&(((child.nodeName=="A")||(child.nodeName=="a"))&&(child.firstChild!=null)&&(child.firstChild.nodeValue!=null)&&(child.firstChild.nodeValue.toLowerCase().indexOf("download")!=-1))){child.onclick=function(){turnOnModal(this);return false;};}}}}
...
if((all[e].className!=null)&&(all[e].className.indexOf(className)!=-1)){elements[elements.length]=all[e];}
return elements;}
function addJiraLink(jiralink){if(jiralink==null||jiralink=='')return;if(document.getElementById("jiralinkitem"))return;var myLI=document.getElementById("issuetrackermenu");var children=myLI.childNodes;var jira=document.createElement("li");jira.className="leaf";jira.id="jiralinkitem"
var link=jira.appendChild(document.createElement("a"));link.href=jiralink;link.appendChild(document.createTextNode("JIRA"));var myUL=document.createElement("ul");myUL.className="level1";myUL.appendChild(jira);for(var c=0;c<children.length;c++){var child=children[c];if(child!=null&&(child.nodeName=='ul'||child.nodeName=='UL')){var itms=child.childNodes;var itmsnum=itms.length;for(var i=0;i<itmsnum;){myUL.appendChild(itms[0]);i++;}
myLI.replaceChild(myUL,child);}else{myLI.appendChild(myUL);}}}
function addHudsonLink(hudsonlink){if(hudsonlink==null||hudsonlink=='')return;if(document.getElementById("hudsonlinkitem"))return;var myLI=document.getElementById("buildmenu");var children=myLI.childNodes;var hudson=document.createElement("li");hudson.className="leaf";hudson.id="hudsonlinkitem"
var link=hudson.appendChild(document.createElement("a"));link.href=hudsonlink;link.appendChild(document.createTextNode("Hudson"));var myUL=document.createElement("ul");myUL.className="level1";myUL.appendChild(hudson);for(var c=0;c<children.length;c++){var child=children[c];if(child!=null&&(child.nodeName=='ul'||child.nodeName=='UL')){var itms=child.childNodes;var itmsnum=itms.length;for(var i=0;i<itmsnum;){myUL.appendChild(itms[0]);i++;}
myLI.replaceChild(myUL,child);}else{myLI.appendChild(myUL);}}}
function addDemosLink(demoslink){if(demoslink==null||demoslink=='')return;if(document.getElementById("demoslinkitem"))return;var myLI=document.getElementById("docsmenu");var children=myLI.childNodes;var demos=document.createElement("li");demos.className="leaf";demos.id="demoslinkitem"
var link=demos.appendChild(document.createElement("a"));link.href=demoslink;link.appendChild(document.createTextNode("Demos"));var myUL=document.createElement("ul");myUL.className="level1";myUL.appendChild(demos);for(var c=0;c<children.length;c++){var child=children[c];if(child!=null&&(child.nodeName=='ul'||child.nodeName=='UL')){var itms=child.childNodes;var itmsnum=itms.length;for(var i=0;i<itmsnum;){myUL.appendChild(itms[0]);i++;}
myLI.replaceChild(myUL,child);}else{myLI.appendChild(myUL);}}}
function addScreenshotsLink(screenshotslink){if(screenshotslink==null||screenshotslink=='')return;if(document.getElementById("screenshotslinkitem"))return;var myLI=document.getElementById("docsmenu");var children=myLI.childNodes;var screenshots=document.createElement("li");screenshots.className="leaf";screenshots.id="screenshotslinkitem"
var link=screenshots.appendChild(document.createElement("a"));link.href=screenshotslink;link.appendChild(document.createTextNode("Screenshots"));var myUL=document.createElement("ul");myUL.className="level1";myUL.appendChild(screenshots);for(var c=0;c<children.length;c++){var child=children[c];if(child!=null&&(child.nodeName=='ul'||child.nodeName=='UL')){var itms=child.childNodes;var itmsnum=itms.length;for(var i=0;i<itmsnum;){myUL.appendChild(itms[0]);i++;}
myLI.replaceChild(myUL,child);}else{myLI.appendChild(myUL);}}}
init();
