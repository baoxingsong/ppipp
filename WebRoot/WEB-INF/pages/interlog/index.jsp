...
<h1>Interolog</h1>
<p>An interolog is a conserved interaction between a pair of proteins which have interacting homologs in another organism. Suppose that A and B are two different interacting human proteins, and A and B are two different interacting dog proteins. Then the interaction between A and B is an interolog of the interaction between A' and B' if the following conditions all hold: 1)A is a homolog of A'. (Protein homologs have similar amino acid sequences and derive from a common ancestral sequence); 2)B is a homolog of B; 3)A and B interact; 4)A' and B' interact. Thus, interologs are homologous pairs of protein interactions across different organisms.</p>
<p>&nbsp;</p>
<p>it needs only the sequence information information. So you should upload the file in FASTA format. <a href="sampledata/QUERY" target="_blank">The sample data could be find here.</a></p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<s:form action="interolog/startInterlog" method="post" target="_self" validate="true">
