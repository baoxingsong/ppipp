...
<h1>D-MIST</h1>
<p>D-MIST is based on a two-step approach. First, potential domain-binding motifs are extracted from structural data. These motifs are then converted to sequence profiles in the form of position-specific scoring matrices (PSSMs). If one protein has a domain and another has corresponding motif information, the two proteins are considered to interact with each other.</p>
<p>&nbsp;</p>
<p>it need the sequence information and the domain information. So you should upload the file in UNIPROT format. <a href="sampledata/uniprot-taxonomy3A4565.txt" target="_blank">The sample data could be find here.</a></p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<s:form action="pssm/startPssm" method="post" target="_self" validate="true">
<tr><td></td><td><input type="file" name="sequencefile" id="sequencefile" /></td></tr>
<tr><td></td><td>Upload Sequence File in UNIPROT Format</td></tr>
