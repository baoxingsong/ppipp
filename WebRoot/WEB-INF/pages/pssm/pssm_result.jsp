...
<div id="download-builder" >
	...
	<p>&nbsp;</p>
	<p>&nbsp;</p>
	<div><a href="pssm/download?inputPath=<s:property value="uuid"/>" target="_blank"><img alt="download" name="download" width="200px" src="skin/images/state/download.jpg"></a></div>
