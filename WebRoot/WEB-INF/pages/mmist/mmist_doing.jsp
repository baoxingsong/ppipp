...
<meta http-equiv="X-UA-Compatible" content="IE=EmulateIE8">
  <head>
	...
	<meta http-equiv="keywords" content="parall-meta, metagenome">
	<meta http-equiv="description" content="parall-meta online">
    ...
    <jsp:include page="/template/head_navigation.txt" />
  	<div id="content-wrapper">
		...
		<div id="download-builder" >
			...
			<p>&nbsp;</p>
			<p>&nbsp;</p>
			<p>You could go to the <a href="mmist/log?uuid=<s:property value="uuid"/>" target="_blank">log page</a> to find the progress.</p>
			<p>&nbsp;</p>
			<p>&nbsp;</p>
			<p>&nbsp;</p>
			<img src="skin/images/state/doing.jpg" alt="doing" witdh="900">
