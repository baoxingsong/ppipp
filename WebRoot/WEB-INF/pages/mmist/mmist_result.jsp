...
<meta http-equiv="X-UA-Compatible" content="IE=EmulateIE8">
  ...
  <jsp:include page="/template/head_navigation.txt" />
	...
	<h1>Congratulations! The protein-protein interaction prediction job was done!</h1>
	<p>&nbsp;</p>
	<p>&nbsp;</p>
	<p>&nbsp;</p>
	<div><a href="mmist/download?inputPath=<s:property value="uuid"/>" target="_blank"><img alt="download" name="download" width="200px" src="skin/images/state/download.jpg"></a></div>
